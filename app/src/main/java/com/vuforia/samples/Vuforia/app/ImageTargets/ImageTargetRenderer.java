...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        if(mActivity.clickScreenPhotoRenderer){
            saveScreenShot(0, 0, mViewWidth, mViewHeight, "test.png");
        }
        mActivity.clickScreenPhotoRenderer = false;
    }
    ...
    public void saveScreenShot(int x, int y, int w, int h, String filename) {
        ...
        try {
            ...
            DebugLog.LOGD("Prueba catch", e.getStackTrace().toString());
        }
    }
